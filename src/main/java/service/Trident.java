    ...
    public Map<Integer, LookupResultOptions> call() throws Exception {
        ...
        for(Product product : productNames){
            ...
            try{
                ...
                System.out.println("Trident Result list from website");
                ...
                /*List<LookupResult> matchedWithAllWords = lookupResultList.stream()
                        ...
                        .collect(Collectors.toList());*/
                System.out.println("Trident matched result with desc, strength, packsize");
                print(matchedWithProdNameAndStrengthAndPackSize);
                if(!matchedWithProdNameAndStrength.isEmpty()){
                    System.out.println("Trident tried matched result with desc, strength and without packsize");
