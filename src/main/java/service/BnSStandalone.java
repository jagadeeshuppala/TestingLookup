...
public class BnSStandalone {



    public static void main(String[] args) throws IOException, InterruptedException {

        BnSStandalone newLogic = new BnSStandalone();
        ...
        //driver.findElement(By.xpath("/html[1]/body[1]/main[1]/div[1]/div[2]/div[1]/div[1]/div[1]/div[1]/div[2]/form[1]/div[3]/input[1]")).sendKeys("84868486");

        driver.findElement(By.xpath("/html[1]/body[1]/main[1]/div[1]/div[2]/div[1]/div[1]/div[1]/div[1]/div[2]/form[1]/div[4]/button[1]"))
                .sendKeys(Keys.RETURN);
        driver.findElement(By.xpath("/html[1]/body[1]/div[4]/div[1]/div[1]/form[1]/div[1]/div[1]/div[3]/button[1]"))
                .sendKeys(Keys.RETURN);
       ...
       /* String fileName = "C:\\JavaWorkSpace\\ProductLookup\\ProductLookup\\src\\main\\resources\\JagOrderList.xlsx";
        ...
        List<Product> productNames = Arrays.asList(// Strength: PackSize:
                ...
                Product.builder().productName("paracetamol soluble tabs").strength("500mg").packsize("24").productNameUnmodified("paracetamol soluble tabs").build(),
                Product.builder().productName("paracetamol soluble tabs").strength("500mg").packsize("60").productNameUnmodified("paracetamol soluble tabs").build(),
                Product.builder().productName("paracetamol soluble tabs").strength("500mg").packsize("100").productNameUnmodified("paracetamol soluble tabs").build()
